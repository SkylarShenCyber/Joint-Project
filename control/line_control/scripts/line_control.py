...
if __name__ == "__main__":
    ...
    # 底盘初始化
    if(line_listener.command_under_start == 1):
    ...
    car_control(line_listener.x_move,line_listener.y_move,line_listener.x_speed,
    line_listener.y_speed,line_listener.angle,line_listener.angle_speed)  # 先
    # 过渡
    package_process = struct.pack(
        "BBBBBBB", 0xfc, 0xfd, 0x02, 0x22, checksum(0x01 + 0x22), 0xfe, 0xff)
